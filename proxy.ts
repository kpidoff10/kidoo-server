...
export function proxy(request: NextRequest) {
  ...
  // Routes /api : bypass total, uniquement CORS. Aucune redirection, rewrite, ou logique métier.
    ...
    if (request.method === 'OPTIONS') {
      return new NextResponse(null, {
        ...
        headers: {
          ...
          'Access-Control-Allow-Headers': 'Content-Type, Authorization, X-Kidoo-Signature, X-Kidoo-Signature-A, X-Kidoo-Signature-B, X-Kidoo-Timestamp',
