...
export function RegionsFrameList({
  ...
  useEffect(() => {
    ...
    if (!v) return;
    const t = hoveredFrameIndex / fps;
    v.currentTime = t;
    v.pause();
  }, [hoveredFrameIndex, fps, isImage]);
      ...
      {hoveredFrameIndex != null && hoverRowRect != null && (
        ...
        >
          {(() => {
            ...
            const frameArtifacts = artifactsByFrame[hoveredFrameIndex] ?? [];
            const hasRegions = frameRegions != null;
            return (
              <>
                <svg aria-hidden className="absolute h-0 w-0">
                  <defs>
                    <mask
                      id={`hover-regions-mask-${hoveredFrameIndex}`}
                ...
                <div
                  ...
                  style={{
                    ...
                    maskImage: `url(#hover-regions-mask-${hoveredFrameIndex})`,
                    maskSize: '100% 100%',
                    maskPosition: '0 0',
                    maskOrigin: 'border-box',
                    WebkitMaskImage: `url(#hover-regions-mask-${hoveredFrameIndex})`,
